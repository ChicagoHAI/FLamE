...
MSG=esnli_k16_flame_phTrue_davinci_predict-then-explain
...
--train_custom_expl_file ${DATA_DIR}/phle_expl/train_davinci_phle.jsonl \
--dev_custom_expl_file ${DATA_DIR}/phle_expl/dev_davinci_phle.jsonl \
--test_custom_expl_file ${DATA_DIR}/phle_expl/test_davinci_phle.jsonl \
